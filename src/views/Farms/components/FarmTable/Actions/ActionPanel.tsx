...
import { LinkExternal, Text } from '@123swap/uikit'
...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  ...
  const info = `https://info.123swap.finance/pair/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        {isActive && (
          <StakeContainer>
            <StyledLinkExternal href={`https://exchange.123swap.finance/#/add/${liquidityUrlPathParts}`}>
