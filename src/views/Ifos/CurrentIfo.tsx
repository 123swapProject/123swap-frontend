...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@123swap/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://exchange.123swap.finance/#/swap" mr="16px">
              {TranslateString(1060, 'Buy CAKE')}
            </LinkExternal>
            <LinkExternal href="https://exchange.123swap.finance/#/add/BNB/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with 123swap, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
