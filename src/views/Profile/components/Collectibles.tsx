...
import { Heading, Text, Flex, ChevronRightIcon } from '@123swap/uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, '123swap Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          '123swap Collectibles are special ERC-721 NFTs that can be used on the 123swap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved 123swap Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved 123swap Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
