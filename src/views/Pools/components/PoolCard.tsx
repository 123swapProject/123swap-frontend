...
import { Button, IconButton, useModal, AddIcon, Image } from '@123swap/uikit'
          ...
          {account &&
            (needsApproval && !isOldSyrup ? (
              ...
              <>
                ...
                <StyledActionSpacer />
                {!isOldSyrup && (
                  <IconButton ml="5px" disabled={isFinished && sousId !== 0} onClick={onPresentDeposit}>
                    <AddIcon m="0 10px" color="white" />
                  </IconButton>
                )}
              </>
            ))}
